...
namespace U8.Interface.Bus.ApiService.Voucher.Factory.CQ.DAL
{
    /// <summary>
    /// HY_DZ_K7_SYNERGISMLOGDT
    /// 
    /// </summary>
    public partial class TaskDetail : ApiService.DAL.TaskLog.ITaskLogDetail
    {
          

        public string getConnStr(Model.Synergismlogdt dt)
        {
            CQ.DAL.Regist rdal = new CQ.DAL.Regist();
        ...
        public U8.Interface.Bus.ApiService.Model.Synergismlogdt GetModel(string autoid)
        {
