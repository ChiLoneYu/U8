...
using System.Data;
using System.Text;
using U8.Interface.Bus.ApiService.DAL.TaskLog;
using U8.Interface.Bus.ApiService.BLL;


namespace U8.Interface.Bus.ApiService.Voucher.Factory.XT.BLL
{
    public class SynergismLog : ApiService.BLL.TaskLog.ITaskLogMain
    {
        private readonly ApiService.DAL.TaskLog.ITaskLogMain dal = ApiService.BLL.ClassFactory.GetITaskLogMainDAL(0);
