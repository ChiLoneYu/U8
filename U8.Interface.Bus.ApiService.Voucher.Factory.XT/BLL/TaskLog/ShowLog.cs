...
{
    public class ShowLog : ApiService.BLL.TaskLog.IShowLog
    {
        private readonly ApiService.DAL.TaskLog.IShowLog dal = new U8.Interface.Bus.ApiService.Voucher.Factory.XT.DAL.ShowLog();
