...
namespace U8.Interface.Bus.ApiService.Voucher.Factory.XT
{
    ...
    /// </summary>
    public class SalesOutStockOrder : OP.SalesOutStockOrder
    {
        ...
        public override string GetCodeorID(string strID, BaseData bd, string codeorid)
        {
            ...
            try
            {
                ...
                Voucher.DAL.Rdrecord32 rd32dal = new Voucher.DAL.Rdrecord32();
        ...
        public override Model.DealResult MakeVouch(BaseData bd)
        {
            ...
            ApiService.BLL.TaskLog.ITaskLogDetail bll = ClassFactory.GetITaskLogDetailBLL(bd.TaskType);
