...
namespace U8.Interface.Bus.ApiService.Voucher.Factory.XT.DAL
{
    /// <summary>
    /// HY_DZ_K7_SYNERGISMLOGDT
    /// 
    /// </summary>
    public partial class SynergismLogDt : ApiService.DAL.TaskLog.ITaskLogDetail
    {
        ...
        private void InsSYNERGISMLOGDTID(Model.Synergismlogdt model)
        {
            ...
            ApiService.BLL.TaskLog.ITaskLogDetail LogDTBLL = ApiService.BLL.ClassFactory.GetITaskLogDetailBLL(model.TaskType);
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.Synergismlogdt GetModel(string autoid,ApiService.BLL.BaseOp op)
        {
        ...
        { 
            ...
            if (rmdoel != null)
            {
                ...
                cimodel.Date = ApiService.BLL.Common.GetVerifyData(dt);
                if (cimodel.Date == DateTime.Now.ToString("yyyy-MM-dd")) cimodel.Date = ApiService.BLL.Common.GetLoginDate(rmdoel);
