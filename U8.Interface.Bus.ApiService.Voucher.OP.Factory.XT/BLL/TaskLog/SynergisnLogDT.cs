...
{
    public class SynergisnLogDT : U8.Interface.Bus.ApiService.BLL.TaskLog.ITaskLogDetail
    {
        private readonly ApiService.DAL.TaskLog.ITaskLogDetail dal = ApiService.BLL.ClassFactory.GetITaskLogDetailDAL(0);
        ...
        public List<Model.Synergismlogdt> DataTableToListAccname(DataTable dt)
        {
            ...
            ApiService.Voucher.Factory.XT.DAL.Regist registdal = new   ApiService.Voucher.Factory.XT.DAL.Regist();
