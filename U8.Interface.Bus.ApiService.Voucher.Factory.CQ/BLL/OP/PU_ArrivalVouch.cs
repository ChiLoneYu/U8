...
using U8.Interface.Bus.ApiService.Voucher.Factory.CQ;
...
namespace U8.Interface.Bus.ApiService.Voucher.Factory.CQ
{
    ...
    { 
        ...
        {
            return Utility.GetModel(tasktype, headtable, cardNo, voucherNoColumnName, opertype, autoid);
        }
        ...
        {
            return Utility.GetLogModel(headtable, cardNo, voucherNoColumnName, opertype, id);
        }
