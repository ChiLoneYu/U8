...
namespace U8.Interface.Bus.ApiService.Voucher.Factory.BJ
{
    ...
    public class Rdrecord01Ret : StockOP
    {
        ...
        public override string GetCodeorID(string strID, BaseData bd, string codeorid)
        {
            ...
            ApiService.BLL.Common.ErrorMsg(ret, "未能获采购入库单ID或单号");
            return ret;
        }
        ...
        {
            return Utility.UpdateMainLog(dt, headtable, voucherNoColumnName, taskStatusflagColName, "cerrordesc_rd");
        }

        //修改日志
        public override int Update(Model.Synergismlogdt dt)
        {
            return Utility.UpdateDetailLog(dt, headtable, voucherNoColumnName, taskStatusflagColName, "cerrordesc_rd");
        }
